# Generated by Django 4.2.5 on 2024-09-30 10:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weather_condition', models.CharField(choices=[('Rainy', 'Rainy'), ('Hot', 'Hot'), ('Snowy', 'Snowy'), ('Humid', 'Humid'), ('Normal', 'Normal')], default='Normal', help_text='Weather condition suitable for this product', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Supplier',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='seeds.product')),
                ('supplier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='seeds.supplier')),
            ],
        ),
        migrations.CreateModel(
            name='PurchaseOrder',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='seeds.order')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='seeds.product')),
            ],
        ),
        migrations.CreateModel(
