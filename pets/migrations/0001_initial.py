# Generated by Django 4.2.5 on 2024-08-27 06:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weather_condition', models.CharField(choices=[('Rainy', 'Rainy'), ('Hot', 'Hot'), ('Snowy', 'Snowy'), ('Humid', 'Humid'), ('Normal', 'Normal')], help_text='Weather condition suitable for this product', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Supplier',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='pets.supplier')),
            ],
        ),
        migrations.CreateModel(
            name='PurchaseOrder',
