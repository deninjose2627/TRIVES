...
SECRET_KEY = 'django-insecure-m)qv8kv(s*hx$uu$px#^6!+ed0$jnm8!q(%9_3)241c$n8u3cm'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'miniproject/static'),  # This includes your static files during development
]
